...
#define FDFS_VOLUMN_STAT_FILTER_BY_IS_DISK_AVAILABLE  1
#define FDFS_VOLUMN_STAT_FILTER_BY_IS_TRUNK_AVAILABLE 2
#define FDFS_VOLUMN_STAT_FILTER_BY_IS_SPACE_AVAILABLE 4

#define FDFS_MB_TO_HUMAN_STR(mb, buff) bytes_to_human_str( \
